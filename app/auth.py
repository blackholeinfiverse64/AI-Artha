...
# JWKS auth removed - using local JWT
class _FakeSupabaseAuth:
    async def __call__(self, request): return None
supabase_auth_dependency = _FakeSupabaseAuth()
get_current_user_supabase = _FakeSupabaseAuth()
get_current_user_supabase_optional = _FakeSupabaseAuth()

class SupabaseAuthUser:
    pass

def get_supabase_auth_health():
    return {"available": False, "reason": "JWKS auth removed"}
